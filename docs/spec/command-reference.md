...
- when the detected tasks are confident enough, the starter contract may also include a minimal `agent` block with safe-task hints, a `protected_paths` entry for `ota.yaml`, and review notes
