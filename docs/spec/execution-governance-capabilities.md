...
| Audited execution boundary crossings | When a heavier non-agent lane is crossed, what was authorized, why, by which bounded authority, and what actually executed? | Crossing classification and receipt provenance are released; signed grant authority remains active V11.7 work | [Audited Execution Boundary Crossings](https://ota.run/docs/reference/audited-execution-boundary-crossings) |
