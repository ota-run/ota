...
- `ota clean` also removes Ota-managed dependency isolation volumes for container contexts that declare `attachments.isolated_paths`, even when those contexts run with `lifecycle: ephemeral`
