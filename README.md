...
- `ota detect --dry-run` infers a candidate contract from repo signals such as package manifests, runtime files, build files, and Docker Compose, then prints provenance and confidence
