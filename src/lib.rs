...
#[allow(dead_code)] // Step 7 compatibility route; provider contact remains inactive.
...
pub mod schema;
pub(crate) mod secret_delivery_admission;
pub(crate) mod secret_delivery_authority_snapshot;
