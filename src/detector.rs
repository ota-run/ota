...
"#,
        ...
        assert!(
            !report
                ...
                .iter()
                .any(|inference| inference.field.starts_with("agent.")),
            "legacy ota-generated agent docs should be excluded from detect evidence"
        );
    }

    #[test]
    fn ignores_ota_generated_claude_doc_as_detect_source() {
        let fixture = Fixture::new();
        fixture.write(
            "CLAUDE.md",
...
"#,
        ...
        assert!(
            !report
                ...
                .iter()
                .any(|inference| inference.field.starts_with("agent.")),
            "ota-generated claude docs should be excluded from detect evidence"
        );
    }
